...
import { verifyOnboardingToken, setupOnboardingPassword } from "@/services/college.service";
...
function VerifyOnboardingContent() {
  ...
  useEffect(() => {
    ...
    async function checkToken() {
      try {
        const response = await verifyOnboardingToken(token);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      await setupOnboardingPassword(token, password);
      setSuccess(true);
