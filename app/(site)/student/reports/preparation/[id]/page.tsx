  ...
  if (!data) {
    return (
      <div className="min-h-[40vh] flex flex-col items-center justify-center text-center space-y-4">
        ...
        <Button onClick={() => router.push("/student/reports/preparation")} size="sm" variant="outline" className="rounded-xl text-xs font-bold">
          Go Back to Reports
        </Button>
      </div>
    );
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in duration-300 pb-16 p-6">
      ...
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" onClick={() => router.push("/student/reports/preparation")} className="rounded-xl text-xs font-bold">
