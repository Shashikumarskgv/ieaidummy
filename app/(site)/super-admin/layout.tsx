...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems: NavItem[] = [
    ...
    { path: "/super-admin/hod-tpo", label: "Colleges Staff", icon: Users },
    { path: "/super-admin/student", label: "Manage Students", icon: BookOpenCheck },
    { path: "/super-admin/hod-activation", label: "HOD Activation", icon: ShieldCheck },
    { path: "/super-admin/tpo-verification", label: "TPO Verification", icon: BookOpen },
    ...
    <div className="min-h-screen bg-[#fafafa] text-foreground flex font-sans overflow-x-hidden relative">
      ...
      <header className="lg:hidden flex items-center justify-between w-full h-16 px-4 border-b border-border bg-card absolute top-0 left-0 z-40">
        <div className="flex items-center gap-2">
          <span className="font-bold text-lg text-foreground">Super Admin Portal</span>
        </div>
        <button
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto scrollbar-hide p-4 space-y-6">
          ...
          <div className="flex items-center justify-between px-2 pt-2">
            <span className="font-bold text-lg tracking-tight text-foreground">Super Admin Portal</span>
            <button
